...
<html lang="en">
    ...
    <body onload="displayUserProfile(); addToCart(); loadMyCart(); removeFromCart(); notifications();">
        ...
        <div id="main">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="breadcrumb-content">
                                <h1 class="breadcrumb-hrading">Photoman</h1>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="product-details-content">
                                ...
                                <div class="pro-details-rating-wrap">
                                    ...
                                    <span class="read-review"><a class="reviews" href="javascript:void(0)">Read reviews <span></span></a></span>
                                </div>
                                ...
                                <div class="pro-details-quality mtb-60px">
                                    <div class="explore-btn btn-hover">
                                        <a href="javascript:void" class="">Explore Works</a>
                                    </div>
                                </div>
                                <div class="pro-details-social-info">
                                    ...
                                    <div class="social-info">
                                        <ul>
                                            <li>
                                                <a href="#" class="fb"><i class="ion-social-facebook"></i></a>
                                            </li>
                                            <li>
                                                <a href="#" class="tw"><i class="ion-social-twitter"></i></a>
                                            </li>
                                            <li>
                                                <a href="#" class="li"><i class="ion-social-linkedin"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="description-review-wrapper">
                        <div class="description-review-topbar nav">
                            <a data-toggle="tab" href="#des-details1">Brief Profile</a>
                            <a class="active" data-toggle="tab" href="#des-details2">Details</a>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="rating-form-style form-submit">
                                                                ...
                                                                <input type="hidden" name="staff_id" id="staff_id" class="required">
            ...
            <section class="recent-add-area mt-30 mb-30px">
                <div class="container">
                    ...
                    <div id="recent-media" class="recent-product-slider owl-carousel owl-nav-style"></div>
                                    ...
                                    <div class="product-details-content quickview-content">
                                        ...
                                        <div class="pro-details-quality">
                                            <div class="pro-details-cart btn-hover">
                                                <a href="javascript:void" class="btn-add-to-cart" data-resource="media"> + Add Album To Cart</a>
                                            </div>
                                        </div>
                                        <div class="pro-details-social-info">
                                            <span>Share</span>
        ...
        <script src="assets/js/pages/photoman.js"></script>
    </body>
</html>
