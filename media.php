                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="breadcrumb-content">
                                <h1 class="breadcrumb-hrading">Media</h1>
                            ...
                            <div class="product-details-content">
                                ...
                                <div class="pro-details-quality mtb-60px">
                                    <div class="pro-details-cart btn-hover">
                                        <a href="javascript:void" class="btn-add-to-cart" data-resource="media"> + Add To Cart</a>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="rating-form-style form-submit">
                                                                ...
                                                                <input type="hidden" name="media_id" id="media_id" class="required">
